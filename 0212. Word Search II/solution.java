/**
 * Other's solution with Backtracking and Trie
 *
 * Intuitively, start from every cell and try to build a word in the dictionary. Backtracking (dfs) is the powerful way to exhaust
 * every possible ways. Apparently, we need to do pruning when current character is not in any word.
