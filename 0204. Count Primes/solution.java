...
/*
 * Official solution -- Sieve of Eratosthenes
...
/*
 * Other's optimized solution -- Sieve of Eratosthenes
 *
 * Time: O(nlogn)
 * Space: O(n)
 */
 ...
 * Other's optimized solution -- Sieve of Eratosthenes
 *
 * There are a few realizations that are crucial to understanding this implementation:
