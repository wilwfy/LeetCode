...
/*
 * Other's solution of HashMap with One Pass
 *
 * Time Complexity: O(N), hardly find the any reason to scan twice.
 * Space Complexity: O(M), where M is the size of different numbers.
 */
class Solution {
    public int findShortestSubArray(int[] nums) {
